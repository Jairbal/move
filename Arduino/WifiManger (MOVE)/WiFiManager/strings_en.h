...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1>MOVE</h1><h3></h3>";
const char * const HTTP_PORTAL_MENU[] PROGMEM = {
"<form action='/wifi'    method='get'><button>Conectarse a una red</button></form><br/>\n", // MENU_WIFI
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Guardando credenciales<br/>Intentando conectar el dispositivo a Internet.<br />Si falla vuelva a conectarse a la Red 'Move' e intentelo nuevamente</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>Guardado<br/></div>";
const char HTTP_END[]              PROGMEM = "</div></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Eliminar la configuración WiFi</button></form>";
