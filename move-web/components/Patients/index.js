...
import { searchFilterPatient } from "firebase/client";

export default function Patients({ patients, handleMorePatients }) {
					...
					{selectedPatient && (
						<div className="col bg-white">
							...
							<div className="d-flex">
								<p className="fw-bold me-3">
									Edad: <span className="fw-normal">{selectedPatient.age}</span>
								</p>
								<p className="fw-bold me-3">
